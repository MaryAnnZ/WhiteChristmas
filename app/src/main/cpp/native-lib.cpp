...
//
//    cv::String face_cascade_name = "/storage/emulated/0/FastHub/haarcascade_frontalface_default.xml";
//    cv::String eyes_cascade_name = "/storage/emulated/0/FastHub/haarcascade_eye.xml";
